      ...
      <Box paddingX="0.75rem" alignX="center">
        ...
        <YAxis alignX="center">
          {/* <div
            ...
            style={{
              backgroundColor:
                theme.mode === "light" ? "none" : ColorPalette["gray-200"],
              borderRadius: "2.5rem",
              width: "8.5rem",
              height: "8.5rem",
              scale:1.5,
          ...
          /> */}
          <BiLockOpen style={{width:`8.5rem`,height:`8.5rem`,padding:`2rem`, background:`${ColorPalette["pink-gradient"]}`,borderRadius:`8px`,border:`1px solid ${ColorPalette.white}`}} />
