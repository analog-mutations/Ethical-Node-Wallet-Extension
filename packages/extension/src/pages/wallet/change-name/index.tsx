...
export const WalletChangeNamePage: FunctionComponent = observer(() => {
  ...
  return (
    ...
    >
      <Styles.Container>
        <BiWallet style={{width:`8.5rem`,height:`8.5rem`,padding:`2rem`, background:`${ColorPalette["pink-gradient"]}`, margin:`4rem auto`,borderRadius:`8px`,border:`1px solid ${ColorPalette.white}`}} />
        <TextInput
