        ...
        {sensitive === "" ? (
          <React.Fragment>
            <Box alignX="center" alignY="center" style={{ flex: 1 }}>
              ...
              /> */}
              <HiOutlineBookOpen style={{width:`8.5rem`,height:`8.5rem`,padding:`2rem`, background:`${ColorPalette["pink-gradient"]}`, margin:`1rem auto`,borderRadius:`8px`,border:`1px solid ${ColorPalette.white}`}} />
