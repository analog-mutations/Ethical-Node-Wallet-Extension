import React, {
  ...
  import { RegisterSceneBox } from "../register/components/register-scene-box";

  import { Stack } from "../../components/stack";
  // import { useRegisterHeader } from "../register/components/header";
  // import {
    // useSceneEvents,
    // useSceneTransition,
   ...
   */
  export const EnableChainsPage: FunctionComponent<{
    vaultId: string;
    ...
    ({
      ...
      return (
        <RegisterSceneBox style={{background:  theme.mode === "light"
        ...
        >
          <FormattedMessage id="page.main.components.manage-chains-modal.title" />
        </Subtitle1>
          ...
          <Gutter size="1.25rem" />
          <Box width="20.5rem" marginX="auto">
             <Button
  ...
  const ChainItem: FunctionComponent<{
    ...
    ({ chainInfo, balance, enabled, blockInteraction, onClick, isFresh }) => {
      ...
      return (
        <Box
        style={{border: `1px solid ${ColorPalette[`light-border`]}`}}
