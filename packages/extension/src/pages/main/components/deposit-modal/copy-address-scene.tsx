                  ...
                  color: (() => {
                    if (isBookmarked) {
                      if (!blockInteraction && isBookmarkHover) {
                        return theme.mode === "light"
                          ? ColorPalette["pink-400"]
                          : ColorPalette["pink-100"] ; // hovered + bookmarked
                      }
                      return ColorPalette["yellow-300"]; // bookmarked
                    }

                    if (!blockInteraction && isBookmarkHover) {
                      return theme.mode === "light"
                        ? ColorPalette["yellow-100"]
                        : ColorPalette["yellow-100"]; // hovered + not bookmarked
                    }

                    return theme.mode === "light"
                      ? ColorPalette["gray-100"]
                      : ColorPalette["gray-200"]; // not hovered + not bookmarked
                  })(),
                }}
                onClick={(e) => {
                  e.preventDefault();
              ...
              <Box padding="0.5rem" alignX="center" alignY="center">
                {hasCopied ? (
                  <CheckToggleIcon
                    width="1.25rem"
                    height="1.25rem"
                    color={ColorPalette["pink-300"]}   //tick copy
                  />
                ) : (
                  <CopyOutlineIcon
                    width="1.25rem"
